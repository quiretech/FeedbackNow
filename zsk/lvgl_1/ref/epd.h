...
public:
  ...
  static const bool useFastFullUpdate =
      true; // set false for extended (low) temperature range
  ...
  void writeScreenBufferAgain(
      uint8_t value =
          0xFF); // init previous buffer controller memory (default white)
