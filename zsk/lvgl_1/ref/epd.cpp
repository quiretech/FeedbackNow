...
// https://www.good-display.com/product/386.html Panel: GDEY042T81 :
// https://www.good-display.com/product/386.html Controller : SSD1683 :
...
GxEPD2_420_GDEY042T81::GxEPD2_420_GDEY042T81(int16_t cs, int16_t dc,
...
void GxEPD2_420_GDEY042T81::writeImage(const uint8_t bitmap[], int16_t x,
                                       int16_t y, int16_t w, int16_t h,
                                       bool invert, bool mirror_y, bool pgm) {
  _writeImage(0x24, bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_420_GDEY042T81::writeImageForFullRefresh(const uint8_t bitmap[],
                                                     int16_t x, int16_t y,
                                                     int16_t w, int16_t h,
...
void GxEPD2_420_GDEY042T81::writeImageAgain(const uint8_t bitmap[], int16_t x,
                                            int16_t y, int16_t w, int16_t h,
                                            bool invert, bool mirror_y,
                                            bool pgm) {
  _writeImage(0x26, bitmap, x, y, w, h, invert, mirror_y, pgm); // set previous
...
void GxEPD2_420_GDEY042T81::_writeImage(uint8_t command, const uint8_t bitmap[],
...
void GxEPD2_420_GDEY042T81::writeImagePart(const uint8_t bitmap[],
...
void GxEPD2_420_GDEY042T81::writeImagePartAgain(
  ...
  _writeImagePart(0x24, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h,
                  invert, mirror_y, pgm);
  _writeImagePart(0x26, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h,
                  invert, mirror_y, pgm);
}

void GxEPD2_420_GDEY042T81::_writeImagePart(
    uint8_t command, const uint8_t bitmap[], int16_t x_part, int16_t y_part,
...
void GxEPD2_420_GDEY042T81::writeImage(const uint8_t *black,
...
void GxEPD2_420_GDEY042T81::writeImagePart(
...
void GxEPD2_420_GDEY042T81::writeNative(const uint8_t *data1,
...
void GxEPD2_420_GDEY042T81::drawImage(const uint8_t bitmap[], int16_t x,
                                      int16_t y, int16_t w, int16_t h,
                                      bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_420_GDEY042T81::drawImagePart(const uint8_t bitmap[],
                                          int16_t x_part, int16_t y_part,
                                          int16_t w_bitmap, int16_t h_bitmap,
                                          int16_t x, int16_t y, int16_t w,
                                          int16_t h, bool invert, bool mirror_y,
...
void GxEPD2_420_GDEY042T81::drawImage(const uint8_t *black,
                                      const uint8_t *color, int16_t x,
                                      int16_t y, int16_t w, int16_t h,
                                      bool invert, bool mirror_y, bool pgm) {
  if (black) {
...
void GxEPD2_420_GDEY042T81::drawImagePart(
    const uint8_t *black, const uint8_t *color, int16_t x_part, int16_t y_part,
    int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y, int16_t w,
    int16_t h, bool invert, bool mirror_y, bool pgm) {
  if (black) {
...
void GxEPD2_420_GDEY042T81::drawNative(const uint8_t *data1,
                                       const uint8_t *data2, int16_t x,
                                       int16_t y, int16_t w, int16_t h,
                                       bool invert, bool mirror_y, bool pgm) {
  if (data1) {
...
void GxEPD2_420_GDEY042T81::refresh(int16_t x, int16_t y, int16_t w,
                                    int16_t h) {
  if (_initial_refresh)
...
void GxEPD2_420_GDEY042T81::_setPartialRamArea(uint16_t x, uint16_t y,
