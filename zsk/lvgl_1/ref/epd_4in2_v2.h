...
static const struct gpio_dt_spec edp_busy_pin =
    GPIO_DT_SPEC_GET(EPD_BUSY, gpios);
...
#define EPD_W21_CS_0                                                           \
  gpio_pin_set_dt(&edp_cs_pin, 0); // GPIO_ResetBits(GPIOD, GPIO_Pin_8)
#define EPD_W21_CS_1                                                           \
  gpio_pin_set_dt(&edp_cs_pin, 1); // GPIO_SetBits(GPIOD, GPIO_Pin_8)

#define EPD_W21_DC_0                                                           \
  gpio_pin_set_dt(&edp_dc_pin, 0); // GPIO_ResetBits(GPIOE, GPIO_Pin_15)
#define EPD_W21_DC_1                                                           \
  gpio_pin_set_dt(&edp_dc_pin, 1); // GPIO_SetBits(GPIOE, GPIO_Pin_15)

#define EPD_W21_RST_0                                                          \
  gpio_pin_set_dt(&edp_res_pin, 0); // GPIO_ResetBits(GPIOE, GPIO_Pin_14)
#define EPD_W21_RST_1                                                          \
  gpio_pin_set_dt(&edp_res_pin, 1); // GPIO_SetBits(GPIOE, GPIO_Pin_14)

#define EPD_W21_BUSY_LEVEL 0
#define isEPD_W21_BUSY                                                         \
  gpio_pin_get_dt(&edp_busy_pin) // GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_13)
