 ...
 * @retval 1..254 battery level, where 1 is the minimum and 254 is the maximum
 * value
 ...
 * can be used for data transmission. Some Network Servers don't use all the
 * channels, in this case, the channels mask must be provided.
 *
...
typedef void (*lorawan_link_check_ans_cb_t)(uint8_t demod_margin,
                                            uint8_t nb_gateways);
 ...
 *
 * @param transport_finished_cb Callback for notification of finished data
 * transfer.
 *
 * @return 0 if successful, negative errno otherwise.
 */
